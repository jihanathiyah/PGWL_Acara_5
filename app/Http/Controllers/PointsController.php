...
class PointsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $name_image = time() . "_point." . strtolower($image->getClientOriginalExtension()); //strtolower untuk memastikan ekstensi file image yang diupload menjadi huruf kecil, sehingga tidak terjadi duplikat nama file image yang disebabkan oleh perbedaan huruf besar dan kecil pada ekstensi file image agar namanya konsisten.
