...
class PolylinesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //Kemudian supaya nama dari image teratur dan tidak duplikat, maka nama image akan dibuat dengan format waktu saat ini ditambah dengan "_polyline" dan ekstensi dari file image yang diupload.

        if ($request->hasFile('image')) {
            $image = $request->file('image');
            $name_image = time() . "_polyline." . strtolower($image->getClientOriginalExtension()); //strtolower untuk memastikan ekstensi file image yang diupload menjadi huruf kecil, sehingga tidak terjadi duplikat nama file image yang disebabkan oleh perbedaan huruf besar dan kecil pada ekstensi file image agar namanya konsisten.
